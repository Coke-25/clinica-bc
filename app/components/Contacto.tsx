...
const contactInfo = [
  {
    title: 'Direccion',
    lines: ['Calle Crta. Betica, 37C', '41300 San Jose de la Rinconada, Sevilla'],
    icon: (
  ...
  {
    title: 'Horario',
    lines: ['Lunes a Viernes', '09:30-13:30 y 16:30-20:00'],
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const services = ['Podologia', 'Fisioterapia', 'Nutricion', 'Psicologia', 'Enfermeria'];
